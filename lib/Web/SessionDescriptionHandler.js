...
var _a = require("wrtc"), mediaDevices = _a.mediaDevices, RTCPeerConnection = _a.RTCPeerConnection;
        ...
        if (this.peerConnection && this.peerConnection.signalingState !== "closed") {
            ...
            if (this.peerConnection.getReceivers) {
                try {
                    ...
                    console.error("A ligação foi encerrada no meio da reprodução do audio", error);
                }
            }
            else {
